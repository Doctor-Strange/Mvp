      ...
      <Section justifyCenter={true}>
        <div className="AboutUsPage">
          ...
          <ul>
            ...
            <li>
              بهتر است عکس خودرو را در زوایای مختلف درونی و بیرونی بارگزاری
              کنید.
            </li>
          ...
          <ul>
            ...
            <li>
              ...
              تماس بگیرید و در صورت بروز مشکل اتولی را در جریان بگذارید.
            </li>
            <li>
              درصورتی که اجاره‌گیرنده بیمه خریداری کند، یک نماینده بیمه بعد از
              هماهنگی‌های لازم، از خودروی شما بازدید خواهد کرد و شما موظف به
              همکاری با مامور بیمه هستید.
            </li>
            <li>
              حتما لیست خودروهایتان را به‌روز نگه‌ دارید و در صورتی که خودرو در
              دسترس نیست در سایت قسمت عدم نمایش را پر کنید.
            </li>
            <li>
            ...
            <li>
              درصورت وجود هرگونه سوال یا ابهامی درباره اجاره‌گیرنده در تماس
              تلفنی آن را مطرح کنید.
            </li>
          </ul>
          ...
          <h2>خودرو را تحویل بگیرید</h2>
          <ul>
            <li>
              در ساعت و محل توافق شده خودرو را از اجاره‌گیرنده تحویل بگیرید.
            </li>
            <li>
            ...
            <li>
              شما باید مبلغ یک میلیون تومان از هزینه ودیعه را جهت جریمه‌های
