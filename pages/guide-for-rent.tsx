      ...
      <Section justifyCenter={true}>
        <div className="AboutUsPage">
          ...
          <ul>
            ...
            <li>
              می‌توانید بین ماشین‌های نمایش داده شده، برند، مدل، سقف قیمت و
              تحویل در محل را فیلتر کنید.
            </li>
          ...
          <ul>
            ...
            <li>
              در قسمت ثبت‌نام وب‌سایت، بعد از وارد کردن شماره موبایل، یک کد
              تایید برای شما پیامک می‌شود.
            </li>
            <li>
              کد پیامک شده را در قسمت مخصوص خود وارد کنید تا ثبت‌نام شما تکمیل
              شود.
            </li>
          </ul>
          ...
          <ul>
            <li>
              پیش از ارسال درخواست رزرو شما به‌عنوان اجاره‌گیرنده می‌توانید یک
              پوشش بیمه برای خودرویی که اجاره می‌کنید انتخاب کنید.
            </li>
            <li>
          ...
          <ul>
            <li>
              بعد از ایجاد حساب کاربری و انتخاب ماشین و خرید بیمه برروی گزینه
              رزرو کلیک کنید.
            </li>
            <li>در صفحه بعد شرایط رزرو خودرو را به‌خوبی مطالعه کنید.</li>
            <li>
              درصورت قبول شرایط برروی گزینه ارسال درخواست کلیک کنید تا درخواست
              رزرو شما برای اجاره‌دهنده ارسال شود.
            </li>
            <li>
              قبول یا رد درخواست شما توسط اجاره‎دهنده ازطریق پیامک برای شما
              ارسال می‌شود.
            </li>
            <li>
              رسیدگی به درخواست شما با توجه به ساعت ارسال درخواست ممکن است از
              چند دقیقه تا چند ساعت زمان ببرد.
            </li>
          </ul>
          <h3>مبلغ اجاره را واریز کنید</h3>
          <ul>
            <li>
              بعد از قبول درخواست شما توسط اجاره‌دهنده، لینک پرداخت برای شما
              ارسال خواهد شد.
            </li>
            <li>
              شما می‌توانید از طریق لینک ارسال شده و یا صفحه کاربری‌تان وجه
              اجاره را واریز کنید.
            </li>
            <li>
            ...
            <li>
              بعد از واریز وجه، اجاره‌دهنده با شما تماس می‌گیرد تا محل تحویل
              خودرو را هماهنگ کنید.
            </li>
            <li>
              درصورتی که هرگونه سوال یا ابهامی درباره خودرو دارید، در تماس تلفنی
              با اجاره‌دهنده مطرح کنید.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              عکس‌برداری و فیلم‌برداری کنید تا در زمان بازگشت آن دچار مشکل
              نشوید.
            </li>
            <li>
            ...
            <li>
              ...
              بودن یا وجود آسیب‌های جدی، خودرو را از اجاره‌دهنده تحویل نگیرید.
              در این شرایط با پشتیبانی اتولی تماس بگیرید تا مشکل پیش‌آمده را
              بررسی و حل کند.
            </li>
            <li>
            ...
            <li>
              از پذیرفتن وسایل اضافی که وجودشان برای شما ضروری نیست خودداری
              کنید.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              حتما گواهینامه و کارت ملی همراه داشته باشید. در صورت نقص هرکدام از
              مدارک، اجاره‌دهنده حق لغو رزرو شما را دارد.
            </li>
            <li>
            ...
            <li>
              یک نسخه از قرارداد امضاشده توسط دو طرف را نزد خود نگه دارید.
            </li>
          </ul>
          <h2>در زمان سفر</h2>
          <h3>سفر به سلامت</h3>
          <ul>
            <li>
              در تمام طول سفر شما موظف هستید بیشترین مراقبت را از خودروی
              اجاره‌ای انجام دهید.
            </li>
            <li>
              در صورت وجود هرگونه مشکل یا خطر برای خودرو حتما اجاره‌دهنده و
              پشتیبانی اتولی را در جریان قرار دهید.
            </li>
            <li>
              درصورتی که اجاره‌دهنده قوانینی برای خودرو وضع کرده است به آن
              پایبند باشید. برای مثال درصورت درخواست اجاره‌دهنده در خودرو سیگار
              نکشید.
            </li>
            <li>
              درصورت تصادف یا سرقت خودرو به اجاره‌دهنده و پلیس اطلاع دهید.
            </li>
            <li>
              در زمان تصادف از آسیب‌های وارد شده به خودرو و صحنه تصادف عکس و
              فیلم تهیه کنید تا در اختیار شرکت بیمه قرار دهید.
            </li>
          </ul>
          <h2>پایان سفر</h2>
