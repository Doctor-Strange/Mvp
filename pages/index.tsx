    ...
    <section className="responsive WHITE whyOtoli">
      ...
      <div className="WhyOtolicontainer">
        <section className="WhyOtolibox">
          <h3>تضمین بیمه</h3>
          <p>با بیمه خودرو اتولی با خیال راحت رانندگی کنید. با اینکه مراقبت از خودروی اجاره‌ای اولین وظیفه شماست، اما در صورت خرابی، تصادف و مشکلات اینچنینی بیمه جبران خسارت خواهد کرد.</p>
        </section>
        <section className="WhyOtolibox">
    ...
    <section className="responsive WHITE whyOtoli">
      ...
      <div className="WhyOtolicontainer">
        ...
        <section className="WhyOtolibox">
          ...
          <p>با خیال راحت کسب درآمد کنید. بیمه خودرو اتولی بابت خسارت‌های احتمالی به شما اطمینان خاطر خواهد داد.
