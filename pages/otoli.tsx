          ...
          <div className="PartOne_OTOLI">
            <div className="partOne_OTOLI_D1 D1_Left">
              ...
              <div>
                ...
                <p>
                  ثبت نام در اتولی ساده است، بعد از وارد کردن شماره تماس کد
                  تایید ارسال شده را وارد کنید و اطلاعاتتان را تکمیل کنید.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  بعد از قبول درخواست رزرو از سمت اجاره‌دهنده، اتولی لینک پرداخت
                  را برای شما ارسال خواهد کرد، از طریق آن و یا از طریق لینک
                  موجود در صفحه سفارش‌ها مبلغ اجاره را پرداخت کنید.
                </p>
              </div>
            </div>
            <div className="partOne_OTOLI_D1 D1_Right">
              ...
              <div>
                ...
                <p>
                  ...
                  توانید سوالات یا ابهامات خود را در تماس با اجاره‌گیرنده مطرح
                  کنید.
                </p>
              </div>
            </div>
            ...
            <div className="partOne_OTOLI_D1 D1_Right">
              <div>
                ...
                <p>
                  ...
                  تمیزی خودرو و میزان کارکرد را بررسی کرده، قرارداد را امضا کنید
                  و ماشین را تحویل دهید.
                </p>
              </div>
              <div>
            ...
            <div className="partOne_OTOLI_D1 D1_Right">
              <div>
                ...
                <p>
                  ...
                  ماشین را تحویل بگیرید، در صفحه سفارش‌ها تحویل خودرو را تایید
                  کنید و به اجاره‌گیرنده امتیاز دهید.
                </p>
              </div>
            </div>
          </div>
