...
export class FilterAndSortBar extends React.Component<{
  ...
  render() {
    ...
    const { brandsFarsi } = brands;
    const { modelsFarsi } = models;
          ...
          <div className="container">
            <ul className="clearfix">
              ...
              <li className="MoreFilterLoad">
                ...
                >
                  <Icon name="options" />{" "}
                  {showFilters ? "جستجوی پیشرفته" : "جستجوی پیشرفته"}
                </a>
              </li>
              <li>
                    ...
                    <ul>
                      <li>
                        <label className="container_check">
                          {" "}
                          تحویل در محل{" "}
                          <small>{stats.deliver_at_renters_place}</small>
                          <input
                            onClick={() => {
                              toggleDeliverAtRentersPlace(
                                !deliverAtRentersPlace
                    ...
                    <ul>
                      <li>
                        <label className="container_check">
                          ...
                          سواری{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 1).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(1);
                            }}
                            type="checkbox"
                          />
                      ...
                      <li>
                        <label className="container_check">
                          ...
                          مینی ون{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 7).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(7);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                      ...
                      <li>
                        <label className="container_check">
                          ...
                          شاسی‌بلند{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 2).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(2);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                      ...
                      <li>
                        <label className="container_check">
                          ...
                          کراس‌اور{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 8).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(8);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                    ...
                    <ul>
                      <li>
                        <label className="container_check">
                          ...
                          کروک{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 3).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(3);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                      ...
                      <li>
                        <label className="container_check">
                          ...
                          کوپه{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 4).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(4);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                      ...
                      <li>
                        <label className="container_check">
                          ...
                          ون{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 5).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(5);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                      ...
                      <li>
                        <label className="container_check">
                          ...
                          وانت{" "}
                          <small>
                            {stats.body_style_set.find(x => x.id === 6).count}
                          </small>
                          <input
                            onClick={e => {
                              toggleToCarBodyType(6);
                            }}
                            type="checkbox"
                          />
                          <span className="checkmark"></span>
                  ...
                  <ul>
                    <li>
                      <label className="container_check">
                        ...
                        <input
                          onClick={() => {
                            toggleDeliverAtRentersPlace(!deliverAtRentersPlace);
                          }}
                          type="checkbox"
                          checked={deliverAtRentersPlace}
                        />
                  ...
                  <ul>
                    ...
                    <li>
                      <label className="container_check">
                        ...
                        هاچ‌بک{" "}
                        <small>
                          {stats.body_style_set.find(x => x.id === 9).count}
                        </small>
                        <input
                          onClick={e => {
                            toggleToCarBodyType(9);
