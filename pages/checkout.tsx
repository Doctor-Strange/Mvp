...
import { Details } from "../src/components/Car";
        ...
        >
          ...
          >
              ...
              <List boldLastItem={true} className="marginni">
                ...
                <li>
                  ...
                  <span className="float-left">
                    {this.state.insurance ? (
                      <span>
                        {convertNumbers2Persian(
                          numberWithCommas(insurance_total_price)
                        )}
                      </span>
                    ) : (
                      <span> ندارد</span>
                ...
                <li className="DiscountCopon">
                    ...
                    <>
                      ...
                      <span style={{ float: "left", direction: "rtl" }}>
                        <span dir="ltr">
                          {convertNumbers2Persian(
                            numberWithCommas(
                              this.state.coupanPrice - discounted_total_price
                            )
                          )}
                        </span>{" "}
                        تومان
                  ...
                  {this.state.coupon_code && (
                    <>
                      <form onSubmit={e => this.CoupanController(e, search_id)}>
                        <input
                          autoFocus
                          type="text"
                          name="COUPAN"
                    ...
                    <span>
                      {this.state.insurance
                        ? this.state.coupanPrice
                          ? convertNumbers2Persian(
                              numberWithCommas(
                                this.state.coupanPrice + insurance_total_price
                              )
                            )
                          : convertNumbers2Persian(
                              numberWithCommas(
            ...
            <div className="mobileView">
              <Insurance
                hasInsurance={this.insuranceCalculator}
                insuranvePrice={insurance_total_price}
              />
            </div>
                        ...
                        <div>
                          <span style={{ fontWeight: "bold" }}>
                            {owner.company_name
                              ? owner.company_name
                              : owner.first_name}{" "}
                            {owner.company_name ? null : owner.last_name}
                          </span>
                        </div>
                      </div>
                      {media_set.length >= 1 ? (
