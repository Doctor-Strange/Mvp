    ...
    <Layout>
      ...
      <Section justifyCenter={true}>
        <div className="AboutUsPage">
          ...
          <p>
            از آنجایی که عکس‌ها به اجاره سریع‌تر خودروی شما کمک می‎کنند، بهتر
            است برای تهیه عکس‌ها زمان بگذارید. همچنین در صورت تمایل و تماس با
            پشتیبانی اتولی، می‌توانید از عکاسان اتولی برای تهیه عکس از خودروتان
            استفاده کنید.
          </p>
          ...
          <ul>
            ...
            <li>
              برای حفظ مسائل امنیتی بهتر است خانه یا محل کار شما در پشت خودرو
              وجود نداشته باشد.
            </li>
            <li>
            ...
            <li>
              اگر خودرو حاوی نشان یا نوشته‌ای خلاف عرف و قوانین است، پیش از
              عکاسی آن را پاک کنید. در صورت بارگذاری تصویر با این نشانه‌ها،
              اتولی حق پیگیری و مسدودکردن حساب شما را دارد.
            </li>
          </ul>
        </div>
      </Section>
